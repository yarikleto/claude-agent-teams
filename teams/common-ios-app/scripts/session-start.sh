...
if [ -f "$CEO_BRAIN" ]; then
  ...
  echo ""
  echo "Your knowledge base is loaded. If it feels outdated, run /common-ios-app-sync to refresh."
else
  echo "=== NO CEO KNOWLEDGE BASE FOUND ==="
  echo ""
  echo "You have no strategic knowledge base for this project yet."
  echo "Run /common-ios-app-brief to study the project and build your knowledge base."
